...
class StateContractController {
  ...
  async init() {
    ...
    // if (typeof this.StateContract.currentProvider.sendAsync !== "function") {
    //     var _contract = this.StateContract;
    //     this.StateContract.currentProvider.sendAsync = function () {
    ...
    // }
    this.StateContract.setProvider(this._web3.currentProvider)
    this.StateContract.setNetwork(contractConfig.NETWORK_ID)
    this._instance = await this.StateContract.at(contractConfig.CONTRACT_ADDRESS.StateContract);
